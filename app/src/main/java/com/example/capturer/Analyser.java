...
public class Analyser implements ImageReader.OnImageAvailableListener {
    ...
    public void onImageAvailable(ImageReader imageReader) {
        ...
        convertYuv2Jpg(yuv_bytes, imageWidth, imageHeight, 80);

        Log.i(TAG, "image size: " + imageHeight + "x" + imageWidth);
        Log.i(TAG, "fps:" + (1000.0/(System.currentTimeMillis() - this.currentTimeMillis)));
        this.currentTimeMillis = System.currentTimeMillis();
        image.close();
    }
